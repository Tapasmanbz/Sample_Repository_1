...
public class MSExcelAutomation {
	 ...
	 * 
	 * @param sheetName
	 * @return number of rows of a sheet
	 */
	...
	public String getCellData(String sheetName, String colName, int rowNum) {
		...
		return "row " + rowNum + " or column " + colName + " does not exist in Controller.xls file";
	}
	 ...
	 * @param rowNum
	 * @param data
	 * @return true if successfully set data to a cell
	 */
	 ...
	 * 
	 * @param sheetName
	 * @return true if sheet exist else false
	 */
	 ...
	 * 
	 * @param sheetName
	 * @return number of column on specific sheet
	 * @return -1 if sheet doesn't exists
	 * @return -1 if no row present on specific sheet
	 */
	 ...
	 * @param colName
	 * @param cellValue
	 * @return row number of a specific cell value under specific column
	 * @return -1 if specific cell value doesn't found under specific column
	 */
